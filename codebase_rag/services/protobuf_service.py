...
LABEL_TO_ONEOF_FIELD: dict[cs.NodeLabel, str] = {
    ...
    cs.NodeLabel.SECTION: cs.ONEOF_SECTION,
    ...
    cs.NodeLabel.KEY: cs.ONEOF_KEY,
    cs.NodeLabel.ACTION: cs.ONEOF_ACTION,
    cs.NodeLabel.DATA_ITEM: cs.ONEOF_DATA_ITEM,
    cs.NodeLabel.TABLE: cs.ONEOF_TABLE,
    cs.NodeLabel.TABLE_EXTENSION: cs.ONEOF_TABLE_EXTENSION,
    cs.NodeLabel.PAGE: cs.ONEOF_PAGE,
    cs.NodeLabel.PAGE_EXTENSION: cs.ONEOF_PAGE_EXTENSION,
    cs.NodeLabel.CODEUNIT: cs.ONEOF_CODEUNIT,
    cs.NodeLabel.REPORT: cs.ONEOF_REPORT,
    cs.NodeLabel.REPORT_EXTENSION: cs.ONEOF_REPORT_EXTENSION,
    cs.NodeLabel.ENUM_EXTENSION: cs.ONEOF_ENUM_EXTENSION,
    cs.NodeLabel.AL_QUERY: cs.ONEOF_AL_QUERY,
    cs.NodeLabel.XMLPORT: cs.ONEOF_XMLPORT,
    cs.NodeLabel.CONTROL_ADDIN: cs.ONEOF_CONTROL_ADDIN,
    cs.NodeLabel.PERMISSION_SET: cs.ONEOF_PERMISSION_SET,
    cs.NodeLabel.ENTITLEMENT: cs.ONEOF_ENTITLEMENT,
    cs.NodeLabel.PROFILE: cs.ONEOF_PROFILE,
    cs.NodeLabel.PROCEDURE: cs.ONEOF_PROCEDURE,
    cs.NodeLabel.TRIGGER: cs.ONEOF_TRIGGER,
    cs.NodeLabel.EVENT_SUBSCRIBER: cs.ONEOF_EVENT_SUBSCRIBER,
    cs.NodeLabel.EXTERNAL_OBJECT: cs.ONEOF_EXTERNAL_OBJECT,
}
