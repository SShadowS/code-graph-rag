...
class GraphUpdater:
    ...
    def _process_single_file(
        ...
        if (
            ...
            and cs.SupportedLanguage.AL in self.parsers
        ):
            self._process_al_file(filepath, file_bytes)
        elif (
            lang_config
            and isinstance(lang_config.language, cs.SupportedLanguage)
            and lang_config.language in self.parsers
    ...
    def _process_al_file(self, filepath: Path, file_bytes: bytes | None = None) -> None:
