...
OPTIONAL MATCH (defined)-[:HAS_FIELD|HAS_KEY|HAS_TRIGGER|HAS_ACTION|HAS_DATAITEM|READS_TABLE|DISPLAYS_FIELD]->(al_child)
DETACH DELETE p, container, defined, al_child
"""

CYPHER_PRUNE_ORPHAN_STUBS = """
MATCH (n:ExternalObject)
OPTIONAL MATCH (x)-[:EXTENDS]->(n)
